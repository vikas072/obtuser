        ...
        >
          ...
          {!loading && user && (!isPaid || (purchasedSemesters?.length || 0) < 8) && (
            <>
              <Link
                href="/dashboard"
                className="group flex items-center gap-3 px-8 py-4 bg-secondary/80 hover:bg-secondary border border-border rounded-xl backdrop-blur-sm transition-all duration-300 hover:border-primary/50 hover:shadow-lg"
              >
          ...
          {!loading && user && isPaid && (
            ...
            >
              ...
              <span className="font-semibold text-white">Go to Dashboard</span>
            </Link>
          )}
        </motion.div>
